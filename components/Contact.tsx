...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setStatus({ type: 'success', message: 'Message sent! Noor Alom  will contact you shortly.' });
    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-3 gap-10 mb-20">
        {[
          ...
          { icon: '📱', title: 'WhatsApp', value: '+8801749378414' },
          { icon: '📧', title: 'Email', value: 'nooralomsm@gmail.com' }
        ].map((item, i) => (
